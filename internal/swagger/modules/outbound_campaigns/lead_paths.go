...
func updateCampaignLeadOperation() oas.Object {
	return oas.Object{"tags": []any{tagName}, "operationId": "updateCampaignLead", "summary": "Update Campaign Lead", "description": "Updates contact details or lifecycle status. Attempts and last_attempted_at are server-maintained.", "security": apiKeySecurity(), "parameters": []any{campaignIDParam(), campaignLeadIDParam()}, "requestBody": requestBodyNamedExamples("Fields to update.", "UpdateCampaignLeadRequest", oas.Object{"called": oas.Object{"summary": "Mark called", "value": oas.Object{"status": "called"}}}), "responses": oas.Object{"200": okJSON("The updated lead.", "UpdateCampaignLeadResponse", campaignLeadResponseExample("Campaign lead updated successfully")), "400": errJSON("Validation failed.", campaignLeadValidationErrorExample()), "401": resp401(), "404": errJSON("Campaign or lead not found.", campaignLeadNotFoundErrorExample()), "409": errJSON("Phone number already exists in this campaign.", campaignLeadConflictErrorExample()), "429": resp429(), "500": resp500()}}
}
